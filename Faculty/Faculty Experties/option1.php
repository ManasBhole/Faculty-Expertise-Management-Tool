...
<form action="/action_page.php">
  ...
  <div class="col-4">
  <select class="form-control border border-secondary" id="sel1">
  ...
  <div class="form-group">
    ...
    <div class="col-4">
    <input type="topic" class="form-control border border-secondary" placeholder="Topic name" id="tpc">
</div>
    </div>
  <div class="form-group">
    <label for="Event name">Event/Course Name:</label>
    <div class="col-4">
    <input type="name" class="form-control border border-secondary" placeholder="Event Name/Course Name" id="event">
    </div>
  </div>
  <div class="form-group">
  ...
  <select class="form-control border border-secondary" id="lvl">
    ...
    <div class="col-5"><input type="name" class="form-control border border-secondary" placeholder="venue name" id="venue"></div>
    </div>
    <div class="col-5">
      <label for="example-date-input" >Date</label>
      <div class="col-6">
        <input class="form-control border border-secondary" type="date" value="2011-08-19" id="example-date-input">
      </div>
    </div>
