...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2020 at 03:45 PM
...
INSERT INTO `awards` (`id`, `Faculty_name`, `Award_name`, `Position`, `Event_name`, `University`, `College_name`, `Level`) VALUES
(3, '', 'hello', '1st', 'hello', 'hello', 'hello', 'Local level'),
(4, 'Shubham', 'bye', '1st', 'bye', 'bye', 'bye', 'Local level');
